...
func main() {
	...
	appServer.Register("/", logMiddleware(IndexHandler))
	appServer.Register("/products", logMiddleware(ProductsHandler))
	appServer.Register("/customers", logMiddleware(CustomersHandler))
